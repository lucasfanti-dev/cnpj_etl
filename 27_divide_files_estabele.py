...
log_filename = '../logs/27_divide_files_estabele.log'
...
if __name__ == "__main__":
    input_folder = "../10column_emprecsv_estabele"
    output_folder = "../11file_division"
    error_folder = "../errors"
    main(input_folder, output_folder, error_folder, chunk_size=500000)
