...
log_filename = '../logs/17_replace_porte_empresa.log'
...
# Função para substituir os valores na coluna 6
@ray.remote
def process_file(file):
    ...
    try:
        ...
        for line in lines:
            ...
            if len(columns) > 5:  # Verifica se a linha tem pelo menos 6 colunas
                if columns[5] == '"00"':
                    columns[5] = '"NAO INFORMADO"'
                elif columns[5] == '"01"':
                    columns[5] = '"MICRO EMPRESA"'
                elif columns[5] == '"03"':
                    columns[5] = '"EMPRESA DE PEQUENO PORTE"'
                elif columns[5] == '"05"':
                    columns[5] = '"DEMAIS"'
