...
log_filename = '../logs/23_unify_simples_estabele.log'
...
def process_files(input_folder, output_folder, unified_estabele, unified_files):
    ...
    with open(Path(output_folder) / f'unified_estabele_simples_chunk_{file_index}.txt', 'w', encoding='utf-8') as final_output:
        for line in unified_est_lines:
            ...
            if line_count >= CHUNK_SIZE:
                ...
                line_count = 0
                final_output.close()
                final_output = open(Path(output_folder) / f'unified_estabele_simples_chunk_{file_index}.txt', 'w', encoding='utf-8')
...
def main():
    ...
    output_folder = "../7unified_simples_estabele"  # Pasta de saída para arquivos concatenados
    os.makedirs(output_folder, exist_ok=True)

    unified_estabele = "../6column_estabele/column_estabele.txt"
    unified_files = ["../4unified_simples_emprecsv/unified_simples.txt"]
